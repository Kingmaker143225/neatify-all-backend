...
# =========================================================
# EXISTING CUSTOMER OTP
# DO NOT CHANGE - OLD WORKING FLOW
# =========================================================
...
# =========================================================
# NEW MSG91 WIDGET AUTHENTICATION
# =========================================================

class CustomerMSG91WidgetVerifyRequest(BaseModel):
    access_token: str = Field(
        ...,
        min_length=1,
        description="MSG91 Widget access token received after successful OTP verification.",
    )


class CustomerMSG91WidgetVerifyResponse(BaseModel):
    success: bool
    is_new_user: bool
    email: str | None = None
    message: str
