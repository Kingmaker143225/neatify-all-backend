...
#                     .create_user(
#                         {
#                             "phone": formatted_phone_with_plus,
#                             "email": user_email,
#                             "phone_confirm": True,
#                             "email_confirm": True,
#                         }
...
#             except Exception as exc:
#                 print(
#                     "⚠️ SUPABASE USER CREATE ERROR:",
#                     repr(exc),
#                 )

#                 # The account may already exist by dummy email.
#                 try:
#                     users_response = (
#                         supabase_admin
#                         .auth.admin
...
#                     print(
#                         "❌ SUPABASE EMAIL USER LOOKUP ERROR:",
#                         repr(lookup_exc),
#                     )

#                     raise HTTPException(
#                         status_code=500,
#                         detail="Failed to find customer account.",
#                     ) from lookup_exc

#                 if not user:
#                     raise HTTPException(
#                         status_code=500,
#                         detail="Failed to create or find customer account.",
#                     )

#                 print(
#                     "✅ Existing customer found by dummy email:",
#                     user.id,
#                 )
