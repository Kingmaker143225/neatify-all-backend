...
class CustomerProfileService:
    ...
    def get_profile(
        ...
        # -----------------------------------------------------
        # PROFILE EMAIL IS THE SOURCE OF TRUTH
        # -----------------------------------------------------
    ...
    def complete_profile(
        ...
        #
        # IMPORTANT:
        # Mobile OTP customers are passwordless.
        #
        # We update only Auth metadata here.
        #
        # We DO NOT update the Supabase Auth email because:
        #
        # 1. The OTP account already has its own internal
        #    phone-based Auth email.
        #
        # 2. The customer's actual email is stored in
        #    profile.email below.
        #
        # 3. Updating Auth email can fail when that email
        #    already belongs to another Auth account.
        #
        # 4. Mobile OTP remains the customer's login method.
        #
        # -----------------------------------------------------
        ...
        # Mobile OTP flow does not send a password.
        #
        # -----------------------------------------------------
